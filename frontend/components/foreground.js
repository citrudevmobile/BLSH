  ...
  return (
    <div class="h-screen w-full bg-white flex flex-col">
      <div class="flex flex-col justify-center items-center pt-5">
        ...
        <p class="text-lg font-black text-center">The path to profits sounds easy; therefore, we created a product to reflect that.</p>
        <p class="text-sm font-black text-center obitron">Automated Crypto Trading Made Easy</p>
